...
class Product(models.Model):
    userid=models.ForeignKey(User,on_delete=models.SET_NULL,null=True)  #SET_NULL will not delete entire row from child table just fill it with null
    productid=models.IntegerField(primary_key=True)
    productname=models.CharField(max_length=60)
    type=(('Mobile','Mobile'),('Cloths','Cloths'),
